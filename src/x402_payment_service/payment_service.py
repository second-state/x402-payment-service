...
class PaymentService:
    ...
    def _create_payment_requirements(self) -> list[PaymentRequirements]:
        ...
        if self.token_config and self.token_config.get("address"):
            # Custom token - calculate amount based on token decimals
            ...
            asset_address = self.token_config["address"]

            # Build EIP-712 domain for custom tokens
            eip712_domain = {}
            ...
            # USDC - use standard x402 processing
    ...
    def parse(
        ...
        """
        payment_header = self.headers.get("X-Payment", "") or self.headers.get(
            "X-PAYMENT", ""
        )
    ...
    async def verify(
        ...
        Args:
            payment: Payment payload to verify (PaymentPayload or EIP2612PaymentPayload)
    ...
    async def settle(
        ...
        Args:
            payment: Payment payload to settle (PaymentPayload or EIP2612PaymentPayload)
        ...
        try:
            ...
            if not settle_response.success:
                ...
                return (
                    ...
                    None,
                    None,
                    f"Payment settlement not success: {error_reason}",
                )
